            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="pr-10">
                ...
                <p className="text-xs sm:text-sm text-[#585858] mt-2 leading-relaxed">
                  ...
                  <a href={`tel:${COMPANY_INFO.phoneRaw}`} onClick={() => trackPhoneClick("project_modal")} data-analytics-handled="true" className="text-[#161616] font-bold underline font-mono-num">
                    {COMPANY_INFO.phone}
                  </a>.
                </p>
              </div>
              ...
              <div className="pt-4 border-t border-[#E0DDDB] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex flex-wrap items-center gap-4 text-xs font-mono-num text-[#585858]">
                  <a href={`tel:${COMPANY_INFO.phoneRaw}`} onClick={() => trackPhoneClick("project_modal_footer")} data-analytics-handled="true" className="flex items-center gap-1.5 hover:text-[#161616] transition-colors">
                    <Phone className="w-3.5 h-3.5 text-[#9F8BE7]" />
                    <span>{COMPANY_INFO.phone}</span>
                  </a>
                  <a href={`mailto:${COMPANY_INFO.email}`} onClick={() => trackEmailClick("project_modal_footer")} data-analytics-handled="true" className="flex items-center gap-1.5 hover:text-[#161616] transition-colors">
