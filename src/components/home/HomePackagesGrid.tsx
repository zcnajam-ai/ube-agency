  ...
  const packages = [
    {
      ...
      desc: "Multi-channel storefront development, marketplace optimization (Amazon, Etsy, eBay), and dropshipping supplier integrations.",
      features: ["Custom Shopify Storefront Build", "Etsy 13-Tag SEO & Banner Kit", "TikTok Shop Catalog Sync", "Multi-Currency Checkout Setup"],
      popular: true,
    },
    {
      ...
      desc: "Get discovered in Google AI Overviews, ChatGPT, and generative search engines with structured schema and topical authority.",
    ...
    },
    {
      ...
      badge: "GOOGLE, META & TIKTOK",
      icon: <Video className="w-5 h-5 text-rose-500" />,
      desc: "Data-backed paid ad campaigns, high-converting video scripts, audience targeting, and Meta CAPI conversion tracking.",
      features: ["Search & Shopping Ads Setup", "Meta Conversions API (CAPI)", "TikTok Video Ad Hooks", "Monthly ROAS & ROI Dashboards"],
      popular: false,
    },
    {
    ...
    },
    {
      ...
      price: "$300",
      priceSub: "one-time starting",
      badge: "RESPONSIVE UI/UX FIGMA",
      icon: <Bot className="w-5 h-5 text-[#9F8BE7]" />,
      desc: "Fast Next.js websites, CMS platforms, responsive Figma design, custom graphics, and Core Web Vitals optimization.",
      features: ["3 to 15 Custom Designed Pages", "Next.js / CMS Architecture", "Speed & Accessibility Tuning", "Contact Form & Lead Routing"],
      popular: false,
    },
    {
      ...
      features: ["Clickable UX Prototype", "Native iOS & Android Code", "App Store Publishing", "Cloud API Backend Integration"],
      popular: false,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 border-b border-[#E0DDDB] pb-6">
          <div className="space-y-2 max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white border border-[#E0DDDB] text-xs font-mono-num text-[#6B46C1] font-bold shadow-2xs">
