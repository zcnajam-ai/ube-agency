          ...
          <div className="lg:col-span-5 relative">
            <div className="p-6 rounded-3xl bg-[#FAF7F6] border border-[#E0DDDB] space-y-6 shadow-xs relative overflow-hidden">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-3.5 rounded-2xl bg-white border border-[#E0DDDB] flex items-center gap-3 shadow-2xs">
                  <CommercePlatformIcon3D platform="shopify" size="md" />
                  <div>
                    <span className="font-display font-bold text-xs text-[#161616] block">Shopify</span>
                    <span className="text-[10px] text-[#585858] font-mono-num">Storefront</span>
                  </div>
                </div>
                ...
                <div className="p-3.5 rounded-2xl bg-white border border-[#E0DDDB] flex items-center gap-3 shadow-2xs">
                  ...
                  <div>
                    <span className="font-display font-bold text-xs text-[#161616] block">Amazon</span>
                    <span className="text-[10px] text-[#585858] font-mono-num">Marketplace</span>
                  </div>
                </div>
                ...
                <div className="p-3.5 rounded-2xl bg-white border border-[#E0DDDB] flex items-center gap-3 shadow-2xs">
                  ...
                  <div>
                    <span className="font-display font-bold text-xs text-[#161616] block">Etsy</span>
                    <span className="text-[10px] text-[#585858] font-mono-num">Niche Shop</span>
                  </div>
                </div>
                ...
                <div className="p-3.5 rounded-2xl bg-white border border-[#E0DDDB] flex items-center gap-3 shadow-2xs">
                  ...
                  <div>
                    <span className="font-display font-bold text-xs text-[#161616] block">eBay</span>
                    <span className="text-[10px] text-[#585858] font-mono-num">Listings</span>
                  </div>
                </div>
              </div>
